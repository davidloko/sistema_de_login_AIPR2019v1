                ...
                <form id="formLogin" class="p-2">
                    ...
                    <div class="form-group mt-5">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label for="lembrar" class="custom-control-label" required <?php if (isset($_COOKIE['nomeUsuario'])) echo " checked"; ?>>
                                Lembrar de mim.
                            </label>
        ...
        <section class="row mb-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaCadastro">
                ...
                <form action="#" class="p-2" id="formCadastro">
                    ...
                    <div class="form-group">
                        <input type="url" name="avatar" id="avatar" class="form-control" placeholder="URL do seu avatar">
                    </div>
                    <div class="form-group mt-5">
                        <div class="custom-control custom-checkbox">
